...
const FiltersBar = ({ filtersProps, selectedPricesRange, handlePrice, valuetext, toggleDrawer }) => {
    ...
    return (
        <>
            ...
            {!md950Up &&
                <Box sx={{
                    display: 'flex', flexDirection: 'column', pl: 4, pr: 4, pt: 2
                }}>
                    <Button onClick={resetFilters} >Borrar filtros</Button>
                    <Link sx={{ pt: 2 }} href={path} >
