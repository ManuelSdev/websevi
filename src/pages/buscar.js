import FindedProductsSection from "../components/products/FindedProductsSection"
...
const Buscar = ({ isLogged, products, categories, filtersProps }) => {
    ...
    return (
        <Layout isLogged={isLogged} categories={categories}>
            <FindedProductsSection products={products} filtersProps={filtersProps} {...props} />
        </Layout>
...
export async function getServerSideProps(context) {
    ...
    const productsRes = await getProducts({ $text: { $search: searchKeys } })
